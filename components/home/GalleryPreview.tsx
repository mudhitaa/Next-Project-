...
const artworks = [
  ...
  {
    src: "https://images.unsplash.com/photo-1501472312651-726afe119ff1?auto=format&fit=crop&w=600&q=80",
    title: "Blue Reverie",
    artist: "Leo Fontaine",
    medium: "Mixed Media",
  },
    ...
    <section className="bg-[#130f0c] py-24">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex items-end justify-between mb-12 flex-wrap gap-4">
          <div>
            <span className="text-xs tracking-[0.3em] text-amber-400 uppercase">Curated Works</span>
            <h2 className="mt-4 text-4xl font-bold text-white font-serif">Featured Gallery</h2>
          </div>
          <Link
            href="/gallery"
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
          {artworks.map((art) => (
            ...
            >
              ...
              <div className="p-4">
                <p className="text-white font-semibold text-sm">{art.title}</p>
                <p className="text-stone-500 text-xs mt-1">{art.artist} · {art.medium}</p>
              </div>
            </Link>
          ))}
        </div>
